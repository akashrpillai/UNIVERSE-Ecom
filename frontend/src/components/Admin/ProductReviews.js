...
import { DELETE_REVIEW_RESET } from "../../constants/productConst";
...
const ProductReviews = ({ history }) => {
    ...
    const { error: deleteError, isDeleted, loading: delLoading } = useSelector((state) => state.review);
    ...
    return (
        <Fragment>
            <MetaData title={`All Reviews Admin | Dashboard | UNIVERSE`} />

            <div className="dashboard">
                <Sidebar />
                <div className="productReviewsContainer">
                    {loading || delLoading ? (<Loader title={delLoading && "Deleting Review"} />) : (
                        <Fragment>
                            <form
